...
class PerformanceAnalyzer:
    ...
    def analyze_comprehensive_performance(self, performance_data: Dict, results_data: Dict):
        """
    ...
    def generate_comprehensive_report(self, results_data: Dict, performance_data: Dict):
        """
        ...
        from .performance_reporter import PerformanceReporter
        reporter = PerformanceReporter()
        return reporter.generate_comprehensive_report(results_data, performance_data)
