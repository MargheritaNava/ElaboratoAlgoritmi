...
class PerformanceReporter:
    ...
    def save_performance_reports(self, analysis_report: Dict, files: List[str], 
                               ...
                               cpu_averages: List[float], complexity_data: Dict) -> Tuple[str, str, str]:
        """
        ...
        """
        # Crea directory di analisi dentro results
    ...
    def generate_comprehensive_report(self, results_data: Dict, performance_data: Dict) -> Optional[str]:
        """
        ...
        try:
            ...
            # Salva i grafici nella directory results/analysis/reports
